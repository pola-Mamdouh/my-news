        ...
        <div className="container mx-auto px-4 py-12 min-h-screen">
          <div className="flex flex-wrap items-center justify-center min-h-[80vh]">
            ...
            <div className="w-full md:w-8/12 lg:w-7/12 xl:w-6/12">
              <img src="/images/login.png" alt="signup" className="w-full" />
            </div>
            ...
            <div className="w-full md:w-7/12 lg:w-5/12 xl:w-5/12 xl:mr-[8.333%]">
              <form action="/login">
                <div className="mb-4">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="username" className="block mt-1 text-sm">اسم المستخدم</label>
                </div>
                <div className="mb-4">
                  <input
                    type="email"
                ...
                <div className="mb-4">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="confirmpassword" className="block mt-1 text-sm">تأكيد كلمة المرور</label>
                </div>
              ...
              <div className="flex mt-4">
                <p className="mb-0 text-sm">في حال كنت تمتلك حساب يمكنك</p>
                <Link to="/login" className="mr-3 text-main text-sm">تسجيل الدخول</Link>
              </div>
